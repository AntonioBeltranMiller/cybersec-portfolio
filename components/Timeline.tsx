  ...
  const experiences = [
    {
      ...
      highlights: [
        'SOC toolkit: Splunk (SPL), QRadar (AQL), Elastic; KQL & Sigma rules',
        'Network & log analysis: Zeek, Suricata, Wireshark, Sysmon & Windows Eventing',
        'Cloud security: AWS Security Hub, GuardDuty, CloudWatch; IAM hardening & alert triage',
        'Perimeter & infra: FortiGate policy tuning, VPN/ZTNA access controls',
        'Threat hunting & malware triage with sandboxing, IOCs, and ATT&CK mapping',
      ],
      impact: 'Ready for L1/L2 SOC Analyst role with proven hands-on workflows across SIEM, EDR, and cloud',
    },
    {
    ...
    },
    {
      ...
      highlights: [
        ...
        'Industry credentials across AWS, Google, Fortinet, SailPoint & CompTIA',
        '500+ hours of hands-on blue-team labs, detection engineering, and incident response',
        'Focus areas: cloud security, identity/IAM, SIEM content, threat hunting',
        'Practice: PortSwigger labs, HTB/THM/PicoCTF; Sigma/KQL detection writing',
      ],
      impact:
