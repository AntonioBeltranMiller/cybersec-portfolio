    ...
    findings: [
      {
        ...
        severity: 'critical',
        description:
          'Detected active exploitation of URGENT/11 vulnerabilities (CVSS 9.8-10.0) targeting IoT/OT devices. 4 attempts captured exploiting TCP stack overflow affecting medical devices, industrial controls, and network equipment.',
        cve: 'CVE-2019-12255',
      },
      {
        ...
        severity: 'high',
        description:
          'Captured attempts to exploit CVE-2020-11900 (CVSS 8.8) for local privilege escalation in enterprise environments. Attackers targeting remote worker infrastructure.',
        cve: 'CVE-2020-11900',
      },
      {
        ...
        severity: 'high',
        description:
          'Sophisticated toll fraud operation using spoofed Cisco-SIPGateway identities targeting premium rate numbers (0075346850780296). Campaign could generate $50,000+ in fraudulent charges per compromised system.',
      },
      {
        title: 'TLS Reconnaissance on Port 64297',
        severity: 'medium',
        description:
          'Advanced reconnaissance from M247 Europe (146.70.185.71) establishing full TLS sessions on non-standard ports, indicating targeted search for hidden services or C2 infrastructure.',
      },
      {
        title: 'Mass Scanner Infrastructure Mapping',
        severity: 'low',
        description:
          'ONYPHE commercial scanner systematically enumerating all 65,535 ports. Data likely sold to both researchers and threat actors, creating operational security concerns.',
      },
    ],
    additionalSections: [
      {
    ...
    blogs: [
      {
        ...
        description:
          'Deep dive into Wind River VxWorks exploitation attempts and their impact on critical infrastructure',
      },
      {
        title: 'Anatomy of a VoIP Toll Fraud Campaign',
        link: '/blog/honeypot/voip-toll-fraud',
        description:
          'Technical analysis of SIP INVITE floods and how criminals monetize compromised PBX systems',
      },
      {
        title: 'Threat Intelligence Sharing: From Detection to Action',
        link: '/blog/honeypot/threat-intel-sharing',
        description:
          'How proper abuse reporting and threat intelligence sharing multiplies defensive impact',
      },
      {
        title: 'Commercial Scanners: The Double-Edged Sword',
        link: '/blog/honeypot/commercial-scanners',
        description:
          "Analysis of ONYPHE and similar platforms role in the threat landscape",
      },
    ],
    outcomes: [
